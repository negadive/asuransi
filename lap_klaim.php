...
<table class="table table-bordered table-hover table-striped">
  <tbody>
	...
	<tr>
		...
		$laporan = mysqli_query($config, "SELECT SUM(k.Total) FROM klaim k JOIN polis p ON k.NomorPolis = p.NomorPolis JOIN nasabah n ON p.KodeNasabah = n.KodeNasabah JOIN rumah r ON p.KodeLokasi = r.KodeLokasi") or die('Gagal mencari'.mysqli_error($config));
