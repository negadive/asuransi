...
<?php
	require "koneksi.php";
	$laporan = mysqli_query($config, "SELECT `KodePos`, `Kecamatan`, `Kelurahan`, `Kota` from `lokasi`") or die('Gagal mencari'.mysqli_error($config));
?>
<div class="container"> 
<a class="btn btn-primary" href="input_lokasi.php">Tambah</a>
<table class="table table-bordered table-hover table-striped">
  <tbody>
	...
	<tr>
      ...
      <td>$data[1]</td>
      <td>$data[3]</td>
      <td><center><a class='btn btn-success' href='edit_lokasi.php?kode=$data[0]'>Edit</a></center></td>
      <td><center><a class='btn btn-danger' href='hapus_lokasi.php?kode=$data[0]'>Hapus</a></center></td>
    </tr>";
		}
	?>
  </tbody>
