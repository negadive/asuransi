...
<?php
	require "koneksi.php";
	$laporan = mysqli_query($config, "SELECT k.NomorKlaim, p.NomorPolis,  p.Tanggal, n.Nama, r.Lokasi, k.Tanggal, k.Total FROM klaim k JOIN polis p ON k.NomorPolis = p.NomorPolis JOIN nasabah n ON p.KodeNasabah = n.KodeNasabah JOIN rumah r ON p.KodeLokasi = r.KodeLokasi") or die('Gagal mencari'.mysqli_error($config));
?>
<div class="container"> 
<a class="btn btn-primary" href="input_klaim_polis.php">Tambah</a>
<table class="table table-bordered table-hover table-striped">
  <tbody>
	...
	<tr>
      ...
      <td><center><a class='btn btn-success' href='edit_klaim_polis.php?klm=$data[0]&pol=$data[1]'>Edit</a></center></td>
      <td><center><a class='btn btn-danger' href='hapus_klaim_polis.php?klm=$data[0]&pol=$data[1]'>Hapus</a></center></td>
    </tr>";
		}
	?>
  </tbody>
