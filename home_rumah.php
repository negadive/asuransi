...
?>
<div class="container"> 
<a class="btn btn-primary" href="input_rumah.php">Tambah</a>
<table class="table table-bordered table-hover table-striped">
  <tbody>
    <tr>
      ...
      <th scope="col" width="5%">Kelas Konstruksi</th>
      <th scope="col">Kode Pos</th>
      <th scope="col">HargaIsiB</th>
      <th scope="col">HargaB</th>
	...
	<tr>
      ...
      <td>$data[8]</td>
      <td>$data[9]</td>
      <td><center><a class='btn btn-success' href='edit_rumah.php?kode=$data[0]'>Edit</a></center></td>
      <td><center><a class='btn btn-danger' href='hapus_rumah.php?kode=$data[0]'>Hapus</a></center></td>
    </tr>";
		}
	?>
  </tbody>
