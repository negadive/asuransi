...
<center><h1>Input Pembayaran Polis</h1></center>
<div>
    <div class="container">
        <form class="form-horizontal" id="in_bayar_polis" name="in_bayar_polis" method="post" action="proc_in_bayar_polis.php">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                <input type="text" class="form-control" name="no_pol" id="no_pol" onChange="cariPolis(this.value)">
                </div>
            </div>
            <div class="form-group">
